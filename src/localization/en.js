export default {
  ...
  visitPage: {
    ...
    currentBenefits: {
      ...
      hasSection8Label: `Do you have Section 8 Housing?`,
      hasSection8Hint:  `Section 8 provides rental housing assistance.`,
      hasSnapLabel:     `Do you have SNAP?`,
      hasSnapHint:      `SNAP provides assistance with buying food`,
    },
    ...
    currentExpenses: {
      ...
      housing: {
        ...
        fuelAssistance: {
          label: `Do you get Fuel Assistance?`,
    ...
    predictions: {
      ...
      tabTitleChanges:         `Changes`, // see Predictions.js
      tabTitleChangesChart:    `Changes Chart`, // see Predictions.js
      tabTitleStackedIncomes:  `Stacked Incomes`, // see Predictions.js
      tabTitleBenefitPrograms: `Benefit Programs`, // see Predictions.js
      chartsHeader:            `With the new pay, how could your benefits change?`,
      warningMessage:          `This tool is in testing and these numbers might not be right. If they're not, please `,
      submitFeedback:          `let us know`,
      // Text Summary:
      summaryTitle:            `Summary`,
      noBenefitsChosen:        `On the first page of questions you didn't choose any of the benefits. If you're not getting any benefits now, this tool can't tell you if you will get any in the future. If you're trying to find help getting into a benefit program, try searching for "social services" in your local area.`,
      noFutureChange:          `There is no change in your household's pay, so there's no change in your benefits.`,
      period:                  `.`,
      eachTimeInterval:        `a month`,  // `eachTime`?
      detailsHeader:           `What could happen?`,
      nowEarn:                 `Right now you earn`,
      nowBenefitsTotalIs:      `and this tool says that your benefits all add up to about`,
      nowTotalIs:              `All together, it says you bring in about`,
      newEarn:                 `If your household's pay changes to`,
      newBenefitsTotalIs:      `this tool says your benefits might add up to about`,
      newBenefitDetailsIntro:  `This is how your benefits might change:`,
      from:                    `might change from about`,
      to:                      `to about`,
      feedbackAsk:             `Are these numbers right? Please `,
      summaryHeader:           `What could it add up to?`,
      newTotalIs:              `If this tool is right, you might bring in about`,
      resultIs:                `That's`,
      moreThan:                `more than before.`,
      lessThan:                `less than before.`,
      sameAs:                  `the same as before.`,
      noCliff:                 `After this, the tool says you could keep bringing in more with each raise.`,
      cliffEndHeader:          `When could things get better?`,
      ifGetTo:                 `The tool says that if you can get to where your household makes about`,
      willGet:                 `you could bring in about`,
      moreIn:                  `more each month all together.`,
      findHelp:                `If you're worried about these results, please search for "social services" in your area to try to find a local case manager.`,
      // Benefits Table:
      benefitsTableTitle:      `Changes`, // see line 265 above
      columnBenefit:           `Benefit`, // see BenefitsTable.js
      columnCurrentBenefits:   `Current Benefits`, // see BenefitsTable.js
      columnNewEstimate:       `New Estimate`, // see BenefitsTable.js
      columnDifference:        `Difference`, // see BenefitsTable.js
      rowSNAP:                 `SNAP`, // see BenefitsTable.js
      rowSection8:             `Section 8 Housing`, // see BenefitsTable.js
      rowTotalBenefits:        `Total Benefits`, // see BenefitsTable.js
      rowIncome:               `Income`, // see BenefitsTable.js
      rowNetTotal:             `Net Total`, // see BenefitsTable.js
      beforeMoney:             `$`, // see BenefitsTable.js multiple lines
      afterMoney:              ` / month`, // see BenefitsTable.js multiple lines
      // Stacked Bar Graph:
      stackedBarGraphTitle:    `Changes Chart`, // see line 266 above
      moneyInAsIncomeChanges:  `Money Coming In as Income Changes`, // see StackedBarGraph.js
      // Stacked Area Graph:
      stackedAreaGraphTitle:   `Stacked Incomes`, // see line 267 above
      allMoneyComingIn:        `All Money Coming In as Income Changes`, // see StackedAreaGraph.js
      // Benefit Programs Graph, showing benefit programs as lines not areas:
      benefitProgramsTitle:    `Individual Benefit Amounts for Household as Income Changes`, // maybe rename as benefitProgramsSubTitle ? see also BenefitsLineGraph.js
      benefitValue:            `Benefit Value ($)`, // see BenefitsLineGraph.js
      // Snippets that are used in more than one chart, table, or graph:
      totalMoney:              `Total Money Coming In ($)`, // see StackedAreaGraph.js, StackedBarGraph.js
      weeklyIncome:            `Weekly Income ($)`,
      monthlyIncome:           `Monthly Income ($)`,
      yearlyIncome:            `Yearly Income ($)`,
      hasIncome:               `Income`,
      hasSNAP:                 `SNAP`,
      hasSection8:             `Section 8`, 
      futureIncomeLine:        `Future Income`, // see VerticalLine.js
      buttonWeekly:            `Weekly`, // see cashflow.js, GraphTimeButtons
      buttonMonthly:           `Monthly`, // see cashflow.js, GraphTimeButtons
      buttonYearly:            `Yearly`, // see cashflow.js, GraphTimeButtons
    },

    warningModal: {
      header:              `IMPORTANT!`,
      warning:             `This tool is in testing.  Predictions should not be used to make financial decisions.`,
      buttonAcceptWarning: `Continue`,
      buttonCancel:        `Cancel`,
      formInstructions:    `Please indicate you understand the following:`,
